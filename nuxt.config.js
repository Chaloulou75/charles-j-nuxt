    ...
    vueI18n: {
      ...
      messages: {
        ...
        es: {
          ...
          tete : 'Pero sobre todo, tenía que mostrar mi cara en algun lado ...',
          ...
          encoretext : 'Autodidacta y apasionado, me formé (y continúo haciéndolo a diario) en distintas plataformas como <a href="https://laracasts.com" target="_blank"> Laracasts </a> y <a href = " https://openclassrooms.com "target =" _ blank "> Openclassrooms </a>, y también gracias a varios canales de Youtube los cuales me enseñaron mucho y no quiero dejar de mencionar (<a href = "https://www.youtube.com/channel/UCzuaB4F2znrMggxcwUuVhAw" target = "_ blank"> Les Teachers Du Net </a>, <a href = "https://www.youtube.com/channel/UCtb40EQj2inp8zuaQlLx3iQ" target = "_ blank"> André Madarang </a> o <a href="https://www.youtube.com/channel/UChyW1pwcQT2RA4Q2onfNfpg" target="_blank"> Thibault Dauce </a> entre otros).',
        ...
        fr: {
          ...
          encore : 'Mais encore?',
          encoretext : 'Autodidacte et passionné, je me suis formé (et continue chaque jour) au travers de plateformes telles que <a href="https://laracasts.com" target="_blank"> Laracasts</a> et <a href="https://openclassrooms.com" target="_blank"> Openclassrooms</a>, mais aussi via diverses chaines Youtube qui m\'ont beaucoup appris et que je tiens à mentionner (<a href="https://www.youtube.com/channel/UCzuaB4F2znrMggxcwUuVhAw" target="_blank"> Les Teachers Du Net</a>, <a href="https://www.youtube.com/channel/UCtb40EQj2inp8zuaQlLx3iQ" target="_blank">André Madarang</a> ou encore <a href="https://www.youtube.com/channel/UChyW1pwcQT2RA4Q2onfNfpg" target="_blank">Thibault Dauce</a> entre autres).',
