<template>
  <div class="my-8 overflow-x-hidden"><!-- encore-->
      <div class="relative pb-8 mx-auto text-xl lg:pb-16 container-inner">
        ...
        <h2 class="mb-4 text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-800 to-blue-800 dark:from-green-400 dark:to-blue-500" id="about" data-scroll>{{ $t('encore') }}</h2>
