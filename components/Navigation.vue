  ...
  <div id="herotop" >
      ...
      <div class="hidden desktop-menu lg:block">
        <ul class="flex items-center justify-around space-x-6 font-semibold uppercase">
          ...
          <div class="flex space-x-2">
            <li class="text-sm text-transparent transition duration-500 ease-in-out transform cursor-pointer hover:translate-x-1 hover:text-green-500 bg-clip-text bg-gradient-to-r dark:from-green-400 dark:to-blue-500 from-green-600 to-blue-700"
          ...
          <button  @click.prevent="toggleTheme"
            class="p-2 text-green-500 transition duration-150 ease-in-out bg-transparent border border-transparent rounded-md dark:text-yellow-300 hover:dark:text-yellow-400 hover:text-green-700 focus:outline-none">
    ...
    <transition name="fade" class="mobile-menu lg:hidden">
        <ul class="flex flex-col items-start px-8 space-y-2 text-sm font-semibold uppercase" v-if="show">
          <!-- <li class="text-transparent transition duration-500 ease-in-out transform cursor-pointer hover:translate-x-2 bg-clip-text bg-gradient-to-r dark:from-green-400 dark:to-blue-500 from-green-600 to-blue-700"><nuxt-link :to="localePath('/posts')">Not Blog</nuxt-link></li> -->
          ...
          <div class="flex space-x-3">
            <li class="text-xs text-transparent transition duration-500 ease-in-out transform cursor-pointer hover:translate-x-1 bg-clip-text bg-gradient-to-r dark:from-green-400 dark:to-blue-500 from-green-600 to-blue-700"
              v-for="locale in availableLocales"
              :key="locale.code"
            >
              <nuxt-link :to="switchLocalePath(locale.code)">
