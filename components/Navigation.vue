<template>
  <div>
    <nav class="flex justify-between w-full px-8 py-8 text-white bg-transparent border-green-700 border-t-14">
      ...
      <nuxt-link :to="localePath('/')" class="font-thin tracking-wider uppercase transition duration-500 ease-in-out transform cursor-pointer hover:translate-x-2">Charles Jeandey</nuxt-link>
