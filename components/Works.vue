<template>
  <div class="overflow-x-hidden works">
      <div class="relative py-8 mx-auto text-xl border-t border-b border-gray-500 lg:py-16 projects container-inner">
        <h2 class="mb-8 text-4xl font-bold text-gray-300" id="projects" data-scroll>{{$t('projects')}}</h2>
        ...
        <ul class="space-y-10 text-lg leading-normal sm:text-xl">
          <li class="checkmark" data-scroll>
            <div class="mb-4"><a href="https://vigilant-goodall-6169be.netlify.app/" target="_blank">Persona Diseño </a></div>
            <div class="text-lg tracking-wider text-gray-400">{{ $t('persona') }} (<a class="text-base font-semibold text-gray-500" href="https://github.com/chaloulou75/persona" target="_blank">GitHub</a>).</div>
          </li>
          <li class="checkmark" data-scroll>
            <div class="mb-4"><a href="https://www.apuestamigo.com/" target="_blank">Apuestamigo</a></div>
          ...
          <li class="checkmark" data-scroll>
            <div class="mb-4"><a href="https://carpinto-sites.netlify.app/" target="_blank">Carpinto</a></div>
          ...
          <!-- <li class="checkmark">
            <div class="mb-4"><a href="https://charles-videogames.netlify.app/" target="_blank">Video Games</a></div>
          ...
          <li class="checkmark" data-scroll>
            <div class="mb-4"><a href="https://charles-jeandey.netlify.app/" target="_blank">Charles Jeandey</a></div>
          ...
          <li class="checkmark" data-scroll>
            <div class="mb-4 font-bold">Julien Leprêtre</div>
