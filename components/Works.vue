      ...
      <div class="relative py-16 mx-auto text-xl border-t border-b border-gray-500 container-inner">
        ...
        <div class="relative mx-2">
          ...
          <div class="relative w-full py-8 space-y-10 text-lg leading-normal bg-gray-100 dark:bg-bluefonce rounded-xl sm:text-xl">
            ...
            <div class="checkmark" data-scroll>
              <div class="mb-4 font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-blue-800 dark:from-green-400 dark:to-blue-500"><a href="https://charles-jeandey.netlify.app/" target="_blank" rel=”noreferrer”>Charles Jeandey</a></div>
