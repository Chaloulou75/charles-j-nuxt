<template>
  <footer class="text-gray-800 bg-transparent dark:text-white">
    <div class="container flex items-center justify-between px-4 py-8 mx-auto lg:px-10">
      <div class="text-xs font-semibold tracking-wide text-gray-700 dark:text-gray-300">	&copy; Charles Jeandey {{ new Date().getFullYear() }}.<br> {{$t('footer')}}.
      </div>
      <ul class="flex items-center space-x-6">
        <li>
          <a href="mailto:c.jeandey@gmail.com" class="text-gray-700 hover:text-gray-800 dark:text-gray-300 hover:dark:text-gray-500">
        ...
        <li>
          <a href="https://twitter.com/CarlitosBuck" target="_blank" rel=”noreferrer” class="text-gray-700 hover:text-gray-800 dark:text-gray-300 hover:dark:text-gray-500">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25" class="w-6 h-6 fill-current"><path fill-rule="nonzero" d="M12.413 0C5.568 0 0 5.569 0 12.413s5.569 12.413 12.413 12.413 12.413-5.569 12.413-12.413C24.826 5.568 19.258 0 12.413 0zm5.538 9.572c.005.123.008.247.008.371 0 3.776-2.873 8.127-8.13 8.127a8.081 8.081 0 0 1-4.379-1.282 5.734 5.734 0 0 0 4.23-1.183 2.86 2.86 0 0 1-2.669-1.984 2.88 2.88 0 0 0 1.29-.049 2.858 2.858 0 0 1-2.292-2.801l.001-.036c.385.213.825.343 1.293.357a2.855 2.855 0 0 1-1.27-2.378c0-.524.14-1.015.386-1.437a8.112 8.112 0 0 0 5.889 2.987 2.857 2.857 0 0 1 4.869-2.607 5.703 5.703 0 0 0 1.814-.694 2.87 2.87 0 0 1-1.258 1.581 5.68 5.68 0 0 0 1.642-.449 5.747 5.747 0 0 1-1.424 1.477z"></path></svg>
          </a>
        </li>
        <li>
          <a href="https://www.linkedin.com/in/charles-jeandey" target="_blank" rel=”noreferrer” class="text-gray-700 hover:text-gray-800 dark:text-gray-300 hover:dark:text-gray-500">
        ...
        <li>
          <a href="https://github.com/Chaloulou75" target="_blank" rel=”noreferrer” class="text-gray-700 hover:text-gray-800 dark:text-gray-300 hover:dark:text-gray-500">
