<template>
  <footer class="text-gray-800 bg-transparent dark:text-white">
    <div class="container flex items-center justify-between px-4 py-8 mx-auto lg:px-10">
      <div class="text-xs font-normal leading-relaxed tracking-wide text-gray-800 dark:text-gray-300">	&copy; Charles Jeandey &bull; {{ new Date().getFullYear() }}<br> {{$t('footer')}}.
      </div>
      <div class="flex items-center px-4 py-2 space-x-3 lg:space-x-6">
        <div>
          <Mailto mail="c.jeandey@gmail.com" class="text-gray-700 hover:text-gray-800 dark:text-gray-300 dark:hover:text-gray-100">
            <svg alt="email" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path><path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path></svg>
          </Mailto>
        </div>
        <div>
          <a href="https://twitter.com/CarlitosBuck" target="_blank" rel=”noreferrer” class="text-gray-700 hover:text-gray-800 dark:text-gray-300 dark:hover:text-gray-100">
            <svg class="w-6 h-6" alt="twitter" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 25 25"><path fill-rule="nonzero" d="M12.413 0C5.568 0 0 5.569 0 12.413s5.569 12.413 12.413 12.413 12.413-5.569 12.413-12.413C24.826 5.568 19.258 0 12.413 0zm5.538 9.572c.005.123.008.247.008.371 0 3.776-2.873 8.127-8.13 8.127a8.081 8.081 0 0 1-4.379-1.282 5.734 5.734 0 0 0 4.23-1.183 2.86 2.86 0 0 1-2.669-1.984 2.88 2.88 0 0 0 1.29-.049 2.858 2.858 0 0 1-2.292-2.801l.001-.036c.385.213.825.343 1.293.357a2.855 2.855 0 0 1-1.27-2.378c0-.524.14-1.015.386-1.437a8.112 8.112 0 0 0 5.889 2.987 2.857 2.857 0 0 1 4.869-2.607 5.703 5.703 0 0 0 1.814-.694 2.87 2.87 0 0 1-1.258 1.581 5.68 5.68 0 0 0 1.642-.449 5.747 5.747 0 0 1-1.424 1.477z"></path></svg>
          </a>
        </div>
        <div>
          <a href="https://www.linkedin.com/in/charles-jeandey" target="_blank" rel=”noreferrer” class="text-gray-700 hover:text-gray-800 dark:text-gray-300 dark:hover:text-gray-100">
            <svg alt="linkedin"  xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
          </a>
        </div>
