<template>
  <footer class="text-white bg-transparent">
    <div class="container flex items-center justify-between px-4 py-8 mx-auto lg:px-10">
      <div class="text-xs">	&copy; Charles Jeandey {{ new Date().getFullYear() }}.<br> {{$t('footer')}}.
      </div>
      <ul class="flex items-center space-x-6">
        ...
        <li>
          <a href="https://twitter.com/CarlitosBuck" target="_blank" class="text-white hover:text-gray-400">
        ...
        <li>
          <a href="https://www.linkedin.com/in/charles-jeandey" target="_blank" class="text-white hover:text-gray-400">
