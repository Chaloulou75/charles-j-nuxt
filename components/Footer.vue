<template>
  <footer class="text-white bg-transparent">
    <div class="container flex items-center justify-between px-4 py-8 mx-auto lg:px-10">
      <div class="text-xs text-gray-300">	&copy; Charles Jeandey {{ new Date().getFullYear() }}.<br> {{$t('footer')}}.
      </div>
      <ul class="flex items-center space-x-6">
        <li>
          <a href="mailto:c.jeandey@gmail.com" class="text-gray-300 hover:text-gray-500">
        ...
        <li>
          <a href="https://twitter.com/CarlitosBuck" target="_blank" rel=”noreferrer” class="text-gray-300 hover:text-gray-500">
        ...
        <li>
          <a href="https://www.linkedin.com/in/charles-jeandey" target="_blank" rel=”noreferrer” class="text-gray-300 hover:text-gray-500">
        ...
        <li>
          <a href="https://github.com/Chaloulou75" target="_blank" rel=”noreferrer” class="text-gray-300 hover:text-gray-500">
