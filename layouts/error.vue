<template>
  <div>
    <div class="flex items-center w-screen h-screen">
      <div
        class="container flex flex-col items-center justify-center px-5 text-gray-100 md:flex-row"
      >
        <div class="max-w-md">
          ...
          <nuxt-link
            to="/"
            class="inline px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg shadow focus:shadow-outline-blue hover:bg-blue-700 focus:outline-none active:bg-blue-600"
            >Home</nuxt-link
          >
        </div>
        <div class="max-w-lg">
